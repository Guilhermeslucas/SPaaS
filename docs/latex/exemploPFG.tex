...
\begin{itemize}
  ...
  um novo pedido de processamento é incluído e também quando um binário é excluído.
...
Nesses ultimos comandos, o arquivo de variáveis que será usado é o environment.prod.ts.
