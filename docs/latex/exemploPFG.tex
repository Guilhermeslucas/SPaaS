...
\begin{itemize}
  ...
  O modelo que está sendo usado para guardar essas informações é:
  ...
  de resultados. O modelo segue o padrão:
  ...
  A coleção também é acessada para autenticação de um novo usuário. Para que todos esses processos sejam executados com sucesso, o modelo usado é:
